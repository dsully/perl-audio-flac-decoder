# This Makefile is for the Audio::FLAC::Decoder extension to perl.
#
...
#     LIBS => [q[-lFLAC]]
#     MYEXTLIB => q[libflacsupport$(LIB_EXT)]
#     NAME => q[Audio::FLAC::Decoder]
#     VERSION_FROM => q[Decoder.pm]
...
FULLEXT = Audio/FLAC/Decoder
BASEEXT = Decoder
PARENT_NAME = Audio::FLAC
DLBASE = $(BASEEXT)
...
INST_LIBDIR      = $(INST_LIB)/Audio/FLAC
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Audio/FLAC
...
TO_INST_PM = Decoder.pm

PM_TO_BLIB = Decoder.pm \
	$(INST_LIB)/Audio/FLAC/Decoder.pm
...
DISTNAME = Audio-FLAC-Decoder
DISTVNAME = Audio-FLAC-Decoder-0.2
...
# Audio::FLAC::Decoder might depend on some other libraries:
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  Decoder.pm $(INST_MAN3DIR)/Audio::FLAC::Decoder.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:         Audio-FLAC-Decoder' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      0.2' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: Decoder.pm' >> META_new.yml
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  Decoder.pm $(INST_LIB)/Audio/FLAC/Decoder.pm 
